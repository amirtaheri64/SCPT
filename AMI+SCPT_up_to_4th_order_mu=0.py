...
def Integrand(M,NUMBER):   # For now number=1
  ...
  if M==4:
    ...
    mult=1.0
  out.append(mult*(-1)**(M+F)*(U**M)*G_val.real/4**M/pi**(2*M))
  out.append(mult*(-1)**(M+F)*(U**M)*G_val.imag/4**M/pi**(2*M))
...
###################################
#Begin
S_list=[[None]*3 for i in range(0,4)]
P_list_freq=[[None]*3 for i in range(0,4)]
P_list_mnta=[[None]*3 for i in range(0,4)]
R_list_freq=[[None]*3 for i in range(0,4)]
R_list_mnta=[[None]*3 for i in range(0,4)]
G_sym_list=[[None]*3 for i in range(0,4)]
F_list=[[None]*3 for i in range(0,4)]
...
for U in [1]:
  for beta in [5]:
    for n in range (0,1):
      ...
      SIGMA_0=0
      SIGMA=0
      file_name='AMI+SCPT_mu=0_with_feed_up_to_4th_vs_iteration_n='+str(n)+'_U='+str(U)+'_beta='+str(beta)+'_pi_half_pi_half_MC=1e6.dat'
      file = open('result_AMI+SCPT_up_to_fourth_with_feedback_iter_1e6_mu=0/'+file_name, 'w')  
      ...
      for i in range(0,50):
        ...
        #print '*******'
        #print
        out_fourth_order_1=naive_mc(4,1)
        print 'Fourth order term_1: Imag part = ', out_fourth_order_1[0], out_fourth_order_1[1]
        print 'Fourth order term_1: Real part = ', out_fourth_order_1[2], out_fourth_order_1[3]
        print '*******'
        print
        out_fourth_order_2=naive_mc(4,2)
        print 'Fourth order term_2: Imag part = ', out_fourth_order_2[0], out_fourth_order_2[1]
        print 'Fourth order term_2: Real part = ', out_fourth_order_2[2], out_fourth_order_2[3]
        print '*******'
        print
        out_fourth_order_3=naive_mc(4,3)
        print 'Fourth order term_3: Imag part = ', out_fourth_order_3[0], out_fourth_order_3[1]
        print 'Fourth order term_3: Real part = ', out_fourth_order_3[2], out_fourth_order_3[3]
        print '*******'
        print
        if i==0:
          SIGMA_1 = U/2.0 + out_second_order[0]*1.0j + out_fourth_order_1[0]*1.0j + out_fourth_order_2[0]*1.0j + out_fourth_order_3[0]*1.0j
          ...
          er_SIGMA_1 = out_second_order[1]*1.0j + out_fourth_order_1[1]*1.0j + out_fourth_order_2[1]*1.0j + out_fourth_order_3[1]*1.0j
        else:
          SIGMA_1 = first_order[0]*1.0j + first_order[2] + out_second_order[0]*1.0j + out_second_order[2] + out_fourth_order_1[0]*1.0j + out_fourth_order_1[2] + out_fourth_order_2[0]*1.0j + out_fourth_order_2[2] + out_fourth_order_3[0]*1.0j + out_fourth_order_3[2]
          er_SIGMA_1 = 1j*first_order[1] + first_order[3] + out_second_order[1]*1.0j + out_second_order[3] + out_fourth_order_1[1]*1.0j + out_fourth_order_1[3] + out_fourth_order_2[1]*1.0j + out_fourth_order_2[3] + out_fourth_order_3[1]*1.0j + out_fourth_order_3[3]
